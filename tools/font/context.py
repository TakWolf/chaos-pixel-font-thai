...
class FontBuildContext:
    ...
    def create_builder(self) -> FontBuilder:
        ...
        for glyph_file in glyph_sequence:
            ...
            horizontal_offset_x, horizontal_offset_y = glyph_file.canvas.horizontal_offset_for_trimmed(self.font_size, self.font_config.baseline)
            advance_width = glyph_file.canvas.advance_width()

            vertical_offset_x, vertical_offset_y = glyph_file.canvas.vertical_offset_for_trimmed(self.font_size)
            vertical_offset_y += vertical_offset_y_delta
            advance_height = glyph_file.canvas.advance_height(self.font_size)
